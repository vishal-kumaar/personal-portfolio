...
export default function Home(props) {
  return (
    <>
      <div
        className={`px-5 flex justify-between items-center flex-col-reverse transition-all duration-300 ease-in-out ${props.opacity}`}
      >
        <div className="py-6">
      ...
      <div className="  my-8 px-5">
        <div className="font-poppins text-lg font-medium mb-4 text-white">
          Get in touch
        </div>
